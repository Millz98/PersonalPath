"""
Django settings for personalpath_project project.
...
SECRET_KEY = 'django-insecure-+$z(kis6)0hxf(nqn#_sj27g3)kp!yfpqsawpm&6%%3py462@a'
...
ROOT_URLCONF = 'personalpath_project.urls'
...
WSGI_APPLICATION = 'personalpath_project.wsgi.application'
...
# python manage.py runserver <<<<< copy and paste this into terminal to run the django server
